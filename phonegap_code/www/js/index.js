...
var app = {
    ...
    onData: function(data) {
       console.log("we in here");
		rfduino.write(data , app.writeSuccess, app.onError);
	},
...
var get_score = function(){
			$.ajax({
								crossDomain: 'true',
								url : 'http://ec2-54-201-233-201.us-west-2.compute.amazonaws.com/happy_score.txt',	   success : function(data){			
...
window.setInterval(get_score, 500);
